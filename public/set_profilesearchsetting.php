...
echo json_encode(
  [
    ...
    "PSGender0" => json_encode($_POST['PSGender0']),
    "PSGender1" => json_encode($_POST['PSGender1']),
    "PSGender2" => json_encode($_POST['PSGender2']),
    "PSGender3" => json_encode($_POST['PSGender3']),
    "PSGender4" => json_encode($_POST['PSGender4']),
    "PSGender5" => json_encode($_POST['PSGender5']),
    "PSGender6" => json_encode($_POST['PSGender6']),
    "PSGender7" => json_encode($_POST['PSGender7']),
